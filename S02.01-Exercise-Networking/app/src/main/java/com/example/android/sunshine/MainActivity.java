    ...
    // DONE (7) Override the onPostExecute method to display the results of the network request
        ...
        protected String[] doInBackground(String... strings) {
            ...
            try {
                ...
                String[] weatherResponseFormatted = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, responseJson);

                return weatherResponseFormatted;
        ...
        @Override
        protected void onPostExecute(String[] weatherResponseFormatted) {
            if (weatherResponseFormatted != null) {
                for (String weatherString : weatherResponseFormatted) {
